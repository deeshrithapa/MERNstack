        ...
        <div className="flex justify-between">
          <div className="flex space-x-7">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <Link to="/event" className="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Event</Link>
      ...
      {isOpen && (
        <div className="md:hidden">
          <ul className="">
            ...
            <li><Link to="/event" className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Event</Link></li>
